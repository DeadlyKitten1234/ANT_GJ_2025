...
const std::string checkpointGripPath = "textures\\CheckpointGrip";
const std::string heart = "textures\\Heart";
const std::string heartBroken = "textures\\HeartBroken";
...
void readLevel(std::vector<int2>& rects, float& stPosX, float& stPosY, int& fieldW, int& fieldH, int& tileSzOut) {
